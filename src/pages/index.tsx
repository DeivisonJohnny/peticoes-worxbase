...
export default function Login() {
  ...
  return (
    <div className=" py-10 ">
      <Card className="w-full max-w-lg shadow-lg py-10 px-4 sm:px-4 max-md:px-2 mx-auto ">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                type="email"
                {...register("email")}
                className={`rounded-xl w-full p-4 text-base lg:text-sm md:text-[14px] sm:text-[13px] placeholder:text-[#CCCCCC] placeholder:italic ${
            ...
            <Button
              type="submit"
              className="w-full bg-[#529FF6] font-bold hover:bg-blue-700 text-white py-4 sm:py-5 text-base lg:text-sm md:text-[14px] sm:text-[13px] rounded-xl cursor-pointer "
            >
              {isLoading ? (
                <>
